exports.getJobSchema = (numPage=1) => {
  jobCategoryId = []
    return new Object({
        requestUrl: 'https://xapi.supercharge-srp.co/job-search/graphql?country=id',
        requestMethod: 'POST',
        ...
        variables: {
            ...
            "categories": [],
            "workTypes":[],
            "userAgent":"Mozilla/5.0%20(X11;%20Linux%20x86_64)%20AppleWebKit/537.36%20(KHTML,%20like%20Gecko)%20Chrome/87.0.4280.66%20Safari/537.36",
            "industries":[],
            "locale":"id"
        }
...
exports.getJobDetailSchema = (jobId) =>{
    return {
            requestUrl: 'https://xapi.supercharge-srp.co/job-search/graphql?country=id',
            requestMethod: 'POST',
            requestBody: JSON.stringify({
                query: `query getJobDetail($jobId: String, $locale: String, $country: String, $candidateId: ID, $solVisitorId: String, $flight: String) {
                  ...
                  `,
                variables: {"jobId": jobId,"country":"id","locale":"id","candidateId":"","solVisitorId":""}
              })
        }
}